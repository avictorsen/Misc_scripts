...
for file in $1/*.bed; do
    ...
    sort -k4 -n ./temp5.bed > ./HOT/$filename
    rm -f ./temp*.bed
    ...
    meme-chip -oc ./$ATF -meme-p 8 -meme-maxsize 10000000 -meme-mod oops -norand -group-thresh 0.001 -filter-thresh 0.0000000001 -bfile $bindir/HOTregions.HMM.background -neg ./masked/$filename.shuf.fa.masked ./masked/$filename.fa.masked
